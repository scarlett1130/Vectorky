...
@Component({
  selector: 'app-geotechnical',
  templateUrl: './geotechnical.component.html',
  styleUrls: ['./geotechnical.component.css']
})
export class GeotechnicalComponent implements OnInit {
